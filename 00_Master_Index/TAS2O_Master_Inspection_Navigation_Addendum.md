# TAS2O Master Inspection Navigation Addendum

This navigation addendum sits behind the master index and provides the primary route to each evidence cluster.

| Evidence cluster | What it covers | Main files to open |
| --- | --- | --- |
| Course core | Course identity, pacing, expectations, and unit planning | Course outline, 110-hour pacing guide, curriculum mapping, unit plans, Indigenous integration evidence addendum |
...
| Specific expectations verification | Official code-by-code curriculum mapping | Specific expectations verification matrix |
...
- Open the master index first, then use this addendum to move to the relevant cluster.
- Keep the master index, this addendum, and the inspection binder index aligned when documents are added or renamed.
- Update the navigation addendum whenever a linked file is revised or replaced.
